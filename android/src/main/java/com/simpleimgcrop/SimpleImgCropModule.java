...
@ReactModule(name = SimpleImgCropModule.NAME)
public class SimpleImgCropModule extends ReactContextBaseJavaModule {
  public static final String NAME = "SimpleImgCrop";
  ...
  public SimpleImgCropModule(ReactApplicationContext reactContext) {
    super(reactContext);
  }
